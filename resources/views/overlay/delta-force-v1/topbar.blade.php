...
<head>
    ...
    <style>
        body {
            background-color: transparent; /* Ubah ke transparan untuk overlay */
            overflow: hidden;
            position: relative;
        ...
        .text-glow { text-shadow: 0 0 8px var(--main-green), 0 0 15px var(--main-green); }
        ...
        .team-logo-sm { height: 50px; width: 50px; object-fit: contain; margin-right: 1rem; }
        .team-panel.right .team-logo-sm { margin-right: 0; margin-left: 1rem; } 

        .team-name { font-size: 1rem; text-transform: uppercase; line-height: 1; }
        .team-score {
            ...
            font-weight: 500;
            margin: 0 1.5rem;
            transition: transform 0.2s ease-out; /* Transisi untuk animasi */
        }
        .team-panel.left .team-score { color: var(--team-1-color); }
        .team-panel.right .team-score { color: var(--team-2-color); }
        ...
        .role-label-bar.defender { background-color: var(--team-2-color); }
        .role-label-bar.attacker { background-color: var(--team-1-color); }
        ...
        .match-info-center .title { font-size: 1rem; color: #aaa; letter-spacing: 2px; }
        .match-info-center .detail { font-family: 'Teko', sans-serif; font-size: 2.5rem; line-height: 1; }

        #sponsor-slideshow-container {
            position: fixed; top: 50%; right: 1rem; transform: translateY(-50%); z-index: 20; background-color: rgba(10, 10, 10, 0.5); backdrop-filter: blur(5px); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 0.375rem; padding: 1rem; width: 12rem;
        }
        #sponsor-slideshow {
            position: relative; width: 100%; height: 8rem;
        }
        .fade-slide {
            position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; opacity: 0; transition: opacity 1s ease-in-out;
        }
    ...
    <div class="top-hud-container">
        ...
        <div class="team-display-column right" style="animation-delay: 0.4s;">
            <div class="team-panel right">
                ...
                <img id="flag-team-b" src="{{ asset('assets/images/flags/' . ($topbarmatch->teamB->country ?? 'default') . '.png') }}" alt="Country Flag" class="team-flag update-anim">
            </div>
